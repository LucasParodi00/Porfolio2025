            ...
            <div className="space-y-6">
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p className="text-pretty">
                  <span className="text-foreground font-semibold">Varlok</span>{" "}
                ...
                <p className="text-pretty">
                  ...
                  desarrollado para optimizar procesos, mejorar la organización
                  y aportar valor al trabajo en el campo.
                </p>

                <p className="text-pretty">
                  Varlok se proyecta como una empresa dedicada al desarrollo de
                  software, marketing digital y SEO profesional, construida con
                  dedicación, esfuerzo constante y una mirada estratégica a
                  largo plazo, con el objetivo de crecer de forma sostenible,
                  estable y escalable.
                </p>
              </div>
